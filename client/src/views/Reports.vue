...
export default {
  ...
  setup() {
    ...
    // Re-fetch whenever any global filter changes
    watch(
    ...
    // Computed summary stats — derived from raw data refs, cached automatically
    ...
    // Cached max revenue so getBarHeight does not recalculate it on every call
    ...
    const formatMonth = (monthStr) => {
      // Convert YYYY-MM to readable "Mon YYYY" format
    ...
    const getBarHeight = (revenue) => {
      // maxRevenue is a cached computed — no per-call loop needed
